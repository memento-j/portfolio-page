...
export default function TechnologyCard({ name, description }: TechnologyCardProps) {
    return(
    <div className="flex items-center py-5 px-5 gap-5 bg-zinc-900 rounded-xl border border-transparent hover:border-zinc-500 hover:bg-zinc-700 hover:scale-103 duration-250">
